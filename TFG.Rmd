...
```{r}
residuos.madrid<- read_excel("C:/Users/isalc/OneDrive - Fundación Universitaria San Pablo CEU/Documentos/TFG/Modelo_residuos_2017-2023_recogida.xlsx")

residuos.comunidadesautonomas<- read.csv("C:/Users/isalc/OneDrive - Fundación Universitaria San Pablo CEU/Documentos/TFG/Cantidad de residuos urbanos recogidos clasificados por tipo de residuo, periodo y comunidades autónomas.csv", sep = ";")
```
